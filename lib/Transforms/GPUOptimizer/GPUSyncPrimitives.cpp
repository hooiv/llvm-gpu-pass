    ...
    for (Instruction &I : BB) {
      ...
      if (auto *Call = dyn_cast<CallInst>(&I)) {
        if (Function *Callee = Call->getCalledFunction()) {
          ...
          if (Name.startswith("atomic") || Name.contains("Atomic") ||
              Call->hasAtomicMemTagSet()) {
    ...
    for (Instruction &I : BB) {
      ...
      if (auto *Call = dyn_cast<CallInst>(&I)) {
        if (Function *Callee = Call->getCalledFunction()) {
          ...
          // Operations that explicitly modify memory ordering
